...
import valora._kernels
from valora.models.peft.triton_kernel.lora.lora_decode import lora_get_qkvo_fwd_expand, lora_get_qkvo_fwd_shrink
...
def bench_ggemm_A():
  ...
  for out_features, (lora_num, per_lora) in itertools.product(lora_ranks, combo):
    ...
    try:
      ...
      result2 = bench(lambda: valora._kernels.dispatch_bgmv(
          t.y_ref, t.x, t.w_T_all.view(-1, 32, 4096//32), t.start_indicies, t.lora_ranks, t.cell_indicies, t.indicies, 0, t.scale))
