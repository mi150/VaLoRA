...
from valora.models.llama.layer_infer.pre_layer_infer import LlamaPreLayerInfer
from valora.utils.infer_utils import mark_cost_time
from valora.server.embed_cache.utils import bytes2tensor, read_shm, get_shm_name_embed
from valora.common.basemodel.triton_kernel.multimodal_emb import multimodal_emb
...
class LlamaMultimodalPreLayerInfer(LlamaPreLayerInfer):
    ...
    def context_forward(self, input_ids, infer_state: LlamaInferStateInfo, layer_weight: LlamaPreAndPostLayerWeight):
        ...
        img_start_loc = 0
        img_start_locs = []
        if infer_state.multimodal_params is not None: # 
