...
from valora.models.llama.triton_kernel.token_attention_nopad_att1 import token_att_fwd, token_att_fwd_int8k
from valora.models.llama.triton_kernel.token_attention_nopad_softmax import token_softmax_fwd
from valora.models.llama.triton_kernel.token_attention_nopad_reduceV import token_att_fwd2, token_att_fwd2_int8v
from valora.models.llama.triton_kernel.rmsnorm import rmsnorm_forward
...
class LlamaTransformerLayerInfer(TransformerLayerInferTpl):
    ...
    def _token_decode_attention_normal(self, q, infer_state: LlamaInferStateInfo):
        ...
        if triton.__version__ == "2.0.0":
            ...
            o_tensor = torch.empty_like(q)
            from valora.models.llama.triton_kernel.token_attention_softmax_and_reducev import token_softmax_reducev_fwd
