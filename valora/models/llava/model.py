...
from valora.models.llava.layer_weights.pre_and_post_layer_weight import LlavaPreAndPostLayerWeight
    ...
    def encode(self, prompt, multimodal_params: MultimodalParams = None):
        ...
        for ids in ids_chunks[1:]:
            ...
            if len(ids) > 0 and ids[0] == self.tokenizer.bos_token_id and self.skip_start:
                ids = ids[1:]
            print(f"multimodal_params.images:{multimodal_params.images[0]}")
