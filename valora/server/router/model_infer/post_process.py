...
from valora.common.basemodel.triton_kernel.apply_penalty import apply_penalty
...
def sample(logits, batch:InferBatch):
    ...
    #     print("error:::::::", e)
    sampled_index = 1
    batch_size = probs_idx.size(0)
    sampled_index = torch.full((batch_size, 1), sampled_index, dtype=torch.long).to(probs_idx.device)
