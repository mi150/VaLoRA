...
def get_tokenizer(
    ...
    **kwargs,
    ...
    try:
        tokenizer = AutoTokenizer.from_pretrained(tokenizer_name, trust_remote_code=True, *args,
                                                  **kwargs)
        ...
        kwargs["use_fast"] = False
        tokenizer = AutoTokenizer.from_pretrained(pretrained_model_name_or_path=tokenizer_name, trust_remote_code=True, *args,
                                                  **kwargs)
