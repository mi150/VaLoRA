...
from valora.models.qwen_vl.qwen_visual import QWenVisionTransformer
from valora.models.llava.llava_visual import LlavaVisionModel
from valora.models.internvl.internvl_visual import InternVLVisionModel
...
class VisualModelRpcServer(rpyc.Service):
    def exposed_init_model(self, kvargs):
        # 注册graceful 退出的处理
        from valora.utils.graceful_utils import graceful_registry
        import inspect
