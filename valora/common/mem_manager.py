...
class MemoryManager:
    ...
    def _init_buffers(self, size, dtype, head_num, head_dim, layer_num):
        self.key_buffer = torch.empty((layer_num, size, head_num, head_dim), dtype=dtype, device="cuda")
        self.value_buffer = torch.empty((layer_num, size, head_num, head_dim), dtype=dtype, device="cuda")
