...
BASE_MODEL = {
        ...
        "Qwen": "models/Qwen-VL-Chat",
        #TODO: add qwen7b & qwenvl configuration
        "qwen7b": "Qwen/Qwen-7B",
        "qwenvl": "/data01/tuwenming/models/Qwen-VL-Chat", # TODO: modify the model path
        "llava7b": "LLava/llava-v1.5-7b",
        "llava13b": "LLava/llava-v1.5-13b",
        "internvl8b": "InternVL/InternVL2-8B",
        "internvl26b": "InternVL/InternVL2-26B",
}

LORA_DIR = {
    "S1": ["dummy-lora-7b-rank-128"],
    "S2": [
        "dummy-lora-7b-rank-128",
        "dummy-lora-7b-rank-64",
        "dummy-lora-7b-rank-32",
        "dummy-lora-7b-rank-16",
        "dummy-lora-7b-rank-8",
    ],
    "S3": ["dummy-lora-13b-rank-16"],
    "S4": [
        "dummy-lora-13b-rank-64",
        "dummy-lora-13b-rank-32",
        "dummy-lora-13b-rank-16",
    ],
    "Real": [
    ...
    "Qwen": [
        "/data01/tuwenming/Qwen-VL/LoRAs/airbus1500",
        "/data01/tuwenming/Qwen-VL/LoRAs/refcoco/LoRA_A",
    ],
    "qwen7b": [
        "Qwen-VL/LoRAs/airbus1500",
        "Qwen-VL/LoRAs/refcoco/LoRA_A",
    ],
    "qwenvl": [
        "/data01/tuwenming/Qwen-VL/LoRAs/airbus1500",
        "/data01/tuwenming/Qwen-VL/LoRAs/refcoco/LoRA_A",
    ...
    "llava7b": [
        "LLaVA/checkpoints/llava-v1.5-7b-task-lora",
    ],
    "llava13b": [
        "LLaVA/checkpoints/llava-v1.5-13b-task-lora",
    ],
    "internvl8b": [
        "InternVL/internvl_chat/pretrained/InternVL2-8B-LoRA",
    ],
    "internvl26b": [
        "InternVL/internvl_chat/pretrained/InternVL2-26B-LoRA",
    ],
}
